...
public class Tweetl {
	...
	public Tweetl(String username, String comuna, String crimen, String retweets, String followers, String likes, String mentions)
	{
		this.setUsername(username);
		this.setCommune(comuna);
